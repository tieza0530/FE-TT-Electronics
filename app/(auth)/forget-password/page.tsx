    ...
    <div className="2xl:px-80 xl:px-16 h-full mt-10">
      ...
      <div className="flex items-center justify-center">
        <div className="my-20 w-1/3 p-10  bg-neutral-100/50 rounded-sm shadow ">
          <p className="text-center text-3xl mb-10 font-semibold">Quên mật khẩu</p>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              />
              <Button type="submit" className="w-full py-6 bg-(--color-main) hover:bg-main/60">Quên mật khẩu</Button>
